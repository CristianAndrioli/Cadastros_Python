...
e_nome.place(x=140, y=11)

l_local = Label(frameMeio, text='Fornecedor', height=1, anchor=NW, font=('Ivy 10 bold'), bg=co1, fg=co4)
l_local.place(x=10, y=40)
e_local = Entry(frameMeio, width=30, justify='left', relief=SOLID)
e_local.place(x=140, y=41)

l_descricao = Label(frameMeio, text='Descrição', height=1, anchor=NW, font=('Ivy 10 bold'), bg=co1, fg=co4)
l_descricao.place(x=10, y=70)
e_descricao = Entry(frameMeio, width=30, justify='left', relief=SOLID)
e_descricao.place(x=140, y=71)
...
e_model.place(x=140, y=101)

l_cal = Label(frameMeio, text='Data da compra', height=1, anchor=NW, font=('Ivy 10 bold'), bg=co1, fg=co4)
l_cal.place(x=10, y=130)
e_cal = DateEntry(frameMeio, width=12, backgroud='darkblue', bordewidth=2, year=2023)
e_cal.place(x=140, y=131)

l_valor = Label(frameMeio, text='Valor da compra', height=1, anchor=NW, font=('Ivy 10 bold'), bg=co1, fg=co4)
l_valor.place(x=10, y=160)
e_valor = Entry(frameMeio, width=30, justify='left', relief=SOLID)
e_valor.place(x=140, y=161)

l_serial = Label(frameMeio, text='Cód. Barras', height=1, anchor=NW, font=('Ivy 10 bold'), bg=co1, fg=co4)
l_serial.place(x=10, y=190)
e_serial = Entry(frameMeio, width=30, justify='left', relief=SOLID)
e_serial.place(x=140, y=191)

#Botão carregar
l_carregar = Label(frameMeio, text='Imagem do produto', height=1, anchor=NW, font=('Ivy 10 bold'), bg=co1, fg=co4)
l_carregar.place(x=10, y=220)
b_carregar = Button(frameMeio,command=escolher_imagem, width=29, text='Carregar imagem'.upper(),compound=CENTER, anchor=CENTER, overrelief=RIDGE, font=('Ivy 8'), bg=co1, fg=co0)
b_carregar.place(x=140, y=221)
...
# Label com quantidade total e valores
l_total = Label(frameMeio, text='' ,width=14, height=2, anchor=CENTER, font=('Ivy 17 bold'), bg=co7, fg=co1)
l_total.place(x=450, y=17)
l_total_ = Label(frameMeio, text='     Valor Total dos Produtos     ', height=1, anchor=NW, font=('Ivy 10 bold'), bg=co7, fg=co1)
...
l_qtd_ = Label(frameMeio, text='   Quantidade total dos itens   ', height=1, anchor=NW, font=('Ivy 10 bold'), bg=co7, fg=co1)
...
def mostrar():
    ...
    tabela_head = ['#Item','Nome',  'Fornecedor','Descrição', 'Marca/Modelo', 'Data da compra','Valor da compra', 'Cód. Barras']
    ...
    l_total['text'] = 'R$ :' + str(Total_valor)
